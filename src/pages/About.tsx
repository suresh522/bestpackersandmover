...
import aboutpackersandmovers from "@/assets/about-packers-and-movers.jpg";
  ...
  return (
    <main className="min-h-screen pt-20">
      <Helmet>
        ...
        <link rel="canonical" href="https://bestpackersandmover.in/about" />
      </Helmet>
