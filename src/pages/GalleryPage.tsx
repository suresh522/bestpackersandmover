...
import servicetransport from "@/assets/vehicletransport/vehicle-transport-packers-and-movers-five.jpg";
  ...
  return (
    <main className="min-h-screen pt-20">
      <Helmet>
        ...
        <link rel="canonical" href="https://bestpackersandmover.in/gallery" />
      </Helmet>
