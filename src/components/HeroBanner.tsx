...
const slides = [
  {
    ...
    subtitle: "Partner",
    description:
      "Professional household & office goods packing, moving, and relocation services available 24/7 across Guntur and beyond.",
  },
  {
    ...
    subtitle: "Moving",
    description:
      "Complete household shifting with multi layer packing, insurance coverage, and doorstep delivery. Your belongings are our responsibility.",
  },
  {
    image: heroOffice,
    title: "Expert",
    ...
    subtitle: "Relocation",
    description:
      "Seamless office shifting with minimal downtime. IT equipment, furniture, and documents handled with professional care.",
  },
  {
    image: heroTransport,
    title: "Reliable",
    ...
    subtitle: "Fleet",
    description:
      "GPS-tracked vehicles with secure loading systems ensure your goods travel safely across any distance.",
  },
  {
    image: heroProject1,
    title: "Premium",
    ...
    subtitle: "Service",
    description:
      "Multi layer bubble wrap, corrugated sheets, and high quality cartons your valuables deserve the best protection.",
  },
  {
    image: heroProject2,
    title: "Happy",
    ...
    subtitle: "Guaranteed",
    description:
      "500+ successful relocations with zero damage delivery. Join our family of satisfied customers across India.",
  },
];
...
const HeroBanner = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-navy-dark">
        ...
        <div className="max-w-3xl">
          ...
          >
            ...
            <span className="font-display text-xs font-semibold tracking-wider text-secondary uppercase">
              BEST PACKERS AND MOVERS • Guntur, AP
            </span>
          </motion.div>
      ...
      <button
        onClick={prev}
        className="absolute left-4 top-1/2 -translate-y-1/2 z-20 rounded-full bg-primary-foreground/10 p-2 text-primary-foreground backdrop-blur-sm hover:bg-primary-foreground/20"
      >
      ...
      <button
        onClick={next}
        className="absolute right-4 top-1/2 -translate-y-1/2 z-20 rounded-full bg-primary-foreground/10 p-2 text-primary-foreground backdrop-blur-sm hover:bg-primary-foreground/20"
      >
