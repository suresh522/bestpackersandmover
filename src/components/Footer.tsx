...
import logoupdated from "@/assets/NEEW-LOGO.png";
      ...
      <div className="container mx-auto px-4 py-12 lg:px-8">
        <div className="grid gap-8 md:grid-cols-3 lg:grid-cols-5">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                { label: "Household Shifting", to: "/household-shifting" },
                { label: "Office Relocation", to: "/office-relocation" },
                { label: "Vehicle Transportation", to: "/vehicle-transportation" },
                { label: "Packing & Unpacking", to: "/packing-unpacking" },
                { label: "Loading & Unloading", to: "/loading-unloading" },
                { label: "Local Shifting", to: "/local-shifting" },
              ].map((link) => (
                <li key={link.to}>
                  <Link
                    to={link.to}
        ...
        <div className="mt-10 border-t border-primary-foreground/10 pt-6 text-center">
          <p className="text-xs text-primary-foreground/40">
            © {new Date().getFullYear()} Best Packers &amp; Movers. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
